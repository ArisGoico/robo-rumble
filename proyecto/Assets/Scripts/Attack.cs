...
public class Attack : MonoBehaviour {
	...
	public void relaxArms(bool relax) { 
		if (relax) {
			leftHJ.highTwistLimit = jointBlockingLimit;
			rightHJ.lowTwistLimit = jointBlockingLimitInv;
			leftHJ.highTwistLimit = jointBlockingLimitInv;
			rightHJ.lowTwistLimit = jointBlockingLimit;
		} else {
			setJointforBlock (leftHJ, false, false);
			setJointforBlock (rightHJ, false, false);
		}
